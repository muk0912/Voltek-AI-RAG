...
class ChatReadRetrieveReadVisionApproach(ChatApproach):
    ...
    def system_message_chat_conversation(self):
        return """
        You are an intelligent assistant helping analyze the knowledge base of Nanoloy, an anode material research company, that also manufactures batteries. The documents contain text, graphs, tables and images.
